...
public class V_Registro extends JFrame {
	...
	public V_Registro() {
		...
		btnRegistrarse1.setBounds(527, 393, 179, 41);
		...
		textField.setFont(new Font("Cascadia Mono", Font.BOLD | Font.ITALIC, 18));
		textField.setBorder(new LineBorder(Color.BLACK, 2)); // Añade un borde negro
		...
		textField_1.setFont(new Font("Cascadia Mono", Font.BOLD | Font.ITALIC, 18));
		textField_1.setBorder(new LineBorder(Color.BLACK, 2)); // Añade un borde negro
		...
		textField_4.setFont(new Font("Cascadia Mono", Font.BOLD | Font.ITALIC, 18));
		textField_4.setBorder(new LineBorder(Color.BLACK, 2)); // Añade un borde negro
		...
		textField_5.setFont(new Font("Cascadia Mono", Font.BOLD | Font.ITALIC, 18));
		textField_5.setBorder(new LineBorder(Color.BLACK, 2)); // Añade un borde negro
		...
		lblNewLabel.setFont(new Font("Cascadia Mono", Font.BOLD | Font.ITALIC, 18));
		lblNewLabel.setBounds(649, 278, 269, 23);
		...
		lblNewLabel_1_2.setFont(new Font("Cascadia Mono", Font.BOLD | Font.ITALIC, 18));
		...
		lblNewLabel_1.setBounds(341, 22, 269, 52);
